...
public class crearProfveedorF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_crear_profveedor_f);
        ...
        ArrayAdapter<entidadFederativa> adapter = new ArrayAdapter<entidadFederativa>(this, android.R.layout.simple_spinner_item, contE.listaEntidades(crearProfveedorF.this));
        ...
        spinnerEntidad.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()  {
            ...
            public void onItemSelected(AdapterView<?> spinner,
                ...
                ArrayAdapter<municipio> adapter2 = new ArrayAdapter<municipio>(crearProfveedorF.this, android.R.layout.simple_spinner_item, contE.listaMunicipios(crearProfveedorF.this,en.getId()));
        ...
        /*entidadFederativa en = (entidadFederativa) spinnerEntidad.getSelectedItem();
        ArrayAdapter<municipio> adapter2 = new ArrayAdapter<municipio>(this, android.R.layout.simple_spinner_item, contE.listaMunicipios(this,en.getId()));
        spinnerMunicipio.setAdapter(adapter2);*/
            ...
            public void onClick(View view) {
                ...
                if(validarCampos()){
                    ...
                    if(crearUsuario(en, mu)){
                        Toast.makeText(crearProfveedorF.this, "Registro creado", Toast.LENGTH_LONG).show();
                        Intent intent  = new Intent(crearProfveedorF.this, proveedores.class);
    ...
    private boolean crearUsuario(entidadFederativa en, municipio mu){
        ...
        if(contP.crearProvF(this,pF)){return true;}else{return false;}
    }
