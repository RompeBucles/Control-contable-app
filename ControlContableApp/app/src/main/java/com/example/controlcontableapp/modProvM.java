...
public class modProvM extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mod_prov_m);
        ...
        ArrayAdapter<entidadFederativa> adapter = new ArrayAdapter<entidadFederativa>(this, android.R.layout.simple_spinner_item, contE.listaEntidades(modProvM.this));
        ...
        spinnerEntidad.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener()  {
            ...
            public void onItemSelected(AdapterView<?> spinner,
                ...
                ArrayAdapter<municipio> adapter2 = new ArrayAdapter<municipio>(modProvM.this, android.R.layout.simple_spinner_item, contE.listaMunicipios(modProvM.this,en.getId()));
            ...
            public void onClick(View view) {
                ...
                if(validarCampos()){
                    ...
                    if(crearUsuario(en, mu)){
                        Toast.makeText(modProvM.this, "Registro creado", Toast.LENGTH_LONG).show();
                        Intent intent  = new Intent(modProvM.this, proveedores.class);
    ...
    private boolean crearUsuario(entidadFederativa en, municipio mu){
        ...
        if(contP.updateProvM(this,pF)){return true;}else{return false;}
    }

    private void cargarUsuario(int id){
        pF = contP.buscarM(modProvM.this,id);

        lblNombreEmp.setText(pF.getNombreEmpresa());
        lblNombre.setText(pF.getNombreApoderado());
        lblApUno.setText(pF.getApellidUno());
        ...
        lblNumero.setText(pF.getTelefono());
